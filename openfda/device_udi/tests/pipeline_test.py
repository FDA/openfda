...
class UDIPipelineTests(unittest.TestCase):
    ...
    def test_annotation(self):
        ...
        harmonized_db.get = lambda product_code, _: (
            {
                "510k": [{"k_number": "K094035"}],
    ...
    def test_xml_to_json(self):
        ...
        def add_fn(id, json):
            ...
            eq_(
                ...
                json["identifiers"][1]["package_status"],
            )
            ...
            eq_(
                "33e1d2ec-8555-43d0-8421-b208e7185d06", json["public_device_record_key"]
            )
            ...
            eq_(
                str("SPACER LAT PEEK 8° 40L X 18W X 10H"),
                json["device_sizes"][1]["text"],
            )
            ...
            eq_(
                "This device must be stored in a dry location away from temperature\n                    extremes",
            ...
            eq_(
                ...
                json["sterilization"]["sterilization_methods"],
            )
