...
class SPLExtractHumiraUnitTest(unittest.TestCase):
    ...
    def test_extract_title(self):
        ...
        self.assertEqual(expected_title, extracted_title, extracted_title)

    def test_extract_id(self):
        expected_id = "2c9fb32d-4b1b-b5da-4bdf-6b06908ba8b3"
        extracted_id = extract.extract_id(self.tree)
        self.assertEqual(expected_id, extracted_id, extracted_id)
    ...
    def test_extract_effective_time(self):
        ...
        self.assertEqual(
            expected_effective_time, extracted_effective_time, extracted_effective_time
        )
    ...
    def test_extract_version_number(self):
        ...
        self.assertEqual(
            expected_version_number, extracted_version_number, extracted_version_number
        )
    ...
    def test_extract_display_name(self):
        ...
        self.assertEqual(
            expected_display_name, extracted_display_name, extracted_display_name
        )

    def test_extract_duns(self):
        expected_duns = "078458370"
        extracted_duns = extract.extract_duns(self.tree)
        self.assertEqual(expected_duns, extracted_duns, extracted_duns)
    ...
    def test_extract_product_ndcs(self):
        ...
        self.assertListEqual(expected_ndcs, extracted_ndcs, extracted_ndcs)

    def test_is_original_packager(self):
        self.assertEqual(True, extract.is_original_packager(self.tree), True)
...
class SPLExtractLipitorRepackUnitTest(unittest.TestCase):
    ...
    def test_is_original_packager(self):
        self.assertEqual(False, extract.is_original_packager(self.tree), False)
