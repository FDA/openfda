...
class UNIIExtractMethoxsalenUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        self.tree = extract_spl.parse_xml(
            os.path.dirname(__file__) + "/data/METHOXSALEN.xml"
        )
    ...
    def test_extract_unii_name(self):
        ...
        self.assertEqual(expected_unii_name, extracted_unii_name, extracted_unii_name)

    def test_extract_unii_other_code(self):
        expected_unii_other_code = [
            "N0000010217",
            "N0000175984",
            "N0000009801",
            "N0000175879",
